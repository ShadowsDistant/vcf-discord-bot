...
const CATEGORIES = {
  profanity: {
    ...
    patterns: [
      ...
      'dumbass', 'jackass', 'motherfucker', 'motherfucka', 'mf you',
      'bastard', 'prick', 'douchebag', 'shithead', 'fuckface',
      'shut the fuck up', 'fuck your mom', 'fuck your mother', 'fuck yo mother',
      'suck my dick', 'suck a dick', 'lick my balls', 'choke on a dick',
      'you suck', 'you are trash', "you're trash", 'youre trash',
      'ratio + L', 'cope harder', 'cry about it',
      /\bf[\W_]*u[\W_]*c[\W_]*k[\W_]*(y[\W_]*o[\W_]*u)?\b/i,
      /\bs[\W_]*t[\W_]*f[\W_]*u\b/i,
      /\bg[\W_]*t[\W_]*f[\W_]*o\b/i,
      /\bm[\W_]*o[\W_]*t[\W_]*h[\W_]*e[\W_]*r[\W_]*f[\W_]*u[\W_]*c[\W_]*k[\W_]*e[\W_]*r\b/i,
    ],
  },
  ...
  slurs: {
    ...
    patterns: [
      ...
      'ni99a', 'ni99er', 'n-word', 'nword', 'hard r', 'hard-r',
      'kike', 'k1ke', 'kyke', 'spic', 'sp1c', 'wetback', 'beaner',
      'chink', 'ch1nk', 'gook', 'g00k', 'jap', 'zipperhead',
      'towelhead', 'raghead', 'camel jockey', 'sand nigger', 'sandnigger',
      'coon', 'c00n', 'jungle bunny', 'porch monkey',
      'cracker', 'honky', 'whitey',
      'tranny', 'tr@nny', 'tr4nny', 'trnny', 'shemale', 'he-she',
      'faggot', 'f4ggot', 'f@ggot', 'fag', 'f@g', 'phaggot', 'f4g',
      'dyke', 'd1ke', 'd@ke',
      'retard', 'r3tard', 'ret@rd', 'retarded', 'r-word',
      'spastic', 'sp4stic', 'spaz', 'spazzo',
      'mongoloid', 'mong', 'mongo',
      'paki', 'p@ki', 'curry muncher',
      'redskin', 'savage indian',
      'gyp', 'gypsy (slur)',
    ],
  },
  ...
  hate: {
    ...
    patterns: [
      ...
      '14 words', '1488', 'heil hitler', 'sieg heil', 'seig heil',
      'gas the jews', 'kill all jews', 'kill all blacks', 'kill all whites',
      'kill all muslims', 'kill all gays',
      'black lives dont matter', 'all lives matter more',
      'ethnic cleansing', 'master race', 'pure race', 'aryan race',
      'death to arabs', 'death to muslims', 'death to jews', 'death to blacks',
      'kkk', 'ku klux klan', 'grand wizard',
      /\bnazi(s)?\b/i,
      /\bfuhrer\b/i,
      'burn the jews', 'jews will not replace',
      'great replacement', 'blood and soil',
      'holocaust denial', 'holohoax',
      'lynching party', 'string them up',
      'send them back', 'go back to africa',
  ...
  sexual: {
    ...
    patterns: [
      ...
      'handjob', 'hand job',
      'anal sex', '@nal sex', 'anal penetration',
      'dildo', 'd1ldo', 'buttplug', 'butt plug',
      'masturbate', 'masturbating', 'masturbation', 'jerk off', 'jerking off',
      'pornhub', 'xvideos', 'xhamster', 'pornography', 'redtube', 'youporn',
      'onlyfans', 'of model', 'hentai', 'doujinshi', 'r34',
      'nude', 'nudes', 'naked pics', 'naked pictures', 'send nudes',
      'child porn', 'child pornography', 'cp', 'cheese pizza', 'loli', 'lolicon', 'shota', 'shotacon',
      'sex tape', 'leaked nudes', 'leaked of',
      'creampie', 'gangbang', 'bukkake', 'rimjob',
      'incest', 'stepmom porn', 'stepsis porn',
      'cum on', 'cum tribute', 'cumshot',
      'doggystyle porn', 'cowgirl position porn',
      /\bsex(ual|ting)?\b/i,
      /\bnsfwb/i,
      /\br[\W_]*ape\b/i,
    ],
  ...
  threats: {
    ...
    patterns: [
      ...
      'ur dead', 'dead meat',
      'kys', 'kill yourself', 'kys now', 'k y s',
      'shoot you', 'shoot up', 'shooting up',
      'bomb threat', 'going to bomb', 'ill bomb', 'plant a bomb',
      'im going to murder', "i'm going to murder", 'gonna murder you',
      'gonna stab', 'going to stab', 'stab you',
      'slit your throat', 'cut your throat',
      'im going to leak your address',
      'i know where your family lives',
      'im going to dox you', 'doxx you', 'doxxed',
      'ill beat you', 'beat the shit out of you',
      'hunt you down', 'find you irl', 'find you in real life',
      'rape you', 'r-pe you',
      /\b(d[o0]x|d[o0]xx)\b/i,
      /\b(swat(ting)?)\b/i,
      'mass shooting', 'school shooting', 'rampage shooting',
      'lone wolf attack', 'manifesto',
    ],
  },
  ...
  drugs: {
    ...
    patterns: [
      'cocaine', 'c0caine', 'blow (drug)',
      'crack cocaine', 'crack rock',
      'methamphetamine', 'meth', 'm3th', 'tweaker',
      'heroin', 'h3roin', 'smack (drug)', 'dope (heroin)',
      'fentanyl', 'fent', 'fenty',
      'ketamine', 'special k', 'k-hole',
      'lsd', 'acid trip', 'dropping acid', 'tab of acid',
      'mdma', 'molly', 'm0lly',
      'ecstasy', 'xanax', 'xans', 'percocet', 'perc 30', 'percs',
      'oxycontin', 'oxys', 'adderall abuse',
      'weed dealer', 'selling weed', 'buy weed',
      'buy drugs', 'sell drugs', 'drug dealer', 'drug plug',
      'plug for drugs', 'dmt', 'shrooms', 'magic mushrooms',
      'syrup lean', 'purple drank',
      'dealer hit me up', 'tryna cop',
  ...
  spam: {
    ...
    patterns: [
      ...
      /(\b\w{1,4}\b[\s,.!?]+){15,}/i, // 15+ tiny words in a row (word spam)
    ],
  },
  ...
  selfharm: {
    ...
    patterns: [
      ...
      'rope and ceiling', 'hang myself', 'noose',
      'overdose on purpose', 'od on purpose',
      'im better off dead', 'no reason to live',
  ...
  doxxing: {
    ...
    patterns: [
      ...
      'i know your address', 'your ip is', 'your real name is',
      'i found your dox', 'dox file', 'dox drop',
      'your real address', 'your parents address',
      'your school is', 'your workplace is',
  ...
  advertising: {
    ...
    patterns: [
      ...
      /t\.co\/[a-z0-9]+/i,
      /lnkd\.in\/[a-z0-9]+/i,
      /\bdm\s+me\s+for\s+(details|info|more|invite)\b/i,
      /\bcheck\s+my\s+(server|discord|profile|bio)\b/i,
      /\bjoin\s+my\s+(server|discord|community|channel)\b/i,
      /\bjoin\s+our\s+server\b/i,
      /\bfree\s+nitro\b/i,
      /\bfree\s+robux\b/i,
      /\bgiveaway\b.{0,30}\bclick\b/i,
      /\bsub(scribe)?\s+to\s+my\s+(channel|yt|youtube|twitch)\b/i,
      /\bfollow\s+me\s+on\s+(twitch|yt|youtube|insta|instagram|tiktok|ig)\b/i,
      'promotional code',
      /hxxps?:\/\/\S+/i,
  ...
  classified: {
    ...
    patterns: [
      ...
      'leaked dm screenshot',
      'leaked mod chat',
      'closed door meeting notes',
    ],
  },
  ...
  politics: {
    ...
    patterns: [
      ...
      'political party', 'gop', 'dnc',
      'maga', 'woke agenda', 'libtard', 'rightoid',
      /\btrump\b/i,
      /\bbiden\b/i,
      /\bobama\b/i,
      /\bharris\b/i,
      /\belection fraud\b/i,
      /\bstolen election\b/i,
      /\bq[\W_]*anon\b/i,
    ],
  },
};
